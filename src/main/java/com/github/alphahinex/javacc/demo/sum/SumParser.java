/* SumParser.java */
/* Generated By:JavaCC: Do not edit this line. SumParser.java */
package com.github.alphahinex.javacc.demo.sum;

/** Simple brace matcher. */
public class SumParser implements SumParserConstants {
...
{if ("" != null) return Integer.parseInt(tk.image);}
  ...
  static public SumParserTokenManager token_source;
  ...
  public SumParser(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public SumParser(java.io.InputStream stream, String encoding) {
	 ...
	 token_source = new SumParserTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  }
  ...
  /** Constructor. */
  public SumParser(java.io.Reader stream) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
 ...
 token_source = new SumParserTokenManager(jj_input_stream);
  ...
  public SumParser(SumParserTokenManager tm) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(SumParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
